...
class SearchPage extends Component {
  ...
  render(){
    ...
    {
      post = <div><label style={{color:'#cc9900' ,fontWeight: 'bold',fontSize:20}}>We Found The Movie </label><Link to={'/lookformovie.herokuapp.com/FoundPage/'+this.state.movie} target='_blank'><button style={{marginLeft:6}}>Let's Go</button></Link></div>;
    }
